...
urlpatterns = [
    ...
    path('custom-product/delete/<int:id>/', CustomProductDelete.as_view()),
    path('address/by-contact/<str:contact_id>/', AddressByContactView.as_view(), name='address-by-contact'),
]